...
router.get('/api/user/user-demographics',verifyJWT, mediaController.getUserDemographics.bind(mediaController));
...
router.get('/api/media/fetch-notifications', verifyJWT, mediaController.handleFetchNotifications.bind(mediaController));
router.post('/api/user/fetchChatList', verifyJWT, mediaController.getChatList.bind(mediaController));
router.get('/api/admin/chartData1',verifyJWT, mediaController.getChartData.bind(mediaController));
